...
public class OrderServiceImpl implements OrderService
{
    ...
    private void checkOutOfRange(String address) {
        ...
        log.info("shopCoordinate = " + shopCoordinate);
        ...
        log.info("shopLngLat = " + shopLngLat);

        // 2、获取用户收货地址的经纬度坐标
        map.put("address", address);
        String userCoordinate = HttpClientUtil.doGet("https://api.map.baidu.com/geocoding/v3", map);
        log.info("userCoordinate = " + userCoordinate);
        ...
        log.info("userLngLat = " + userLngLat);
    ...
    public void complete(Long id) {
        ...
        // 校验订单是否存在，并且状态为4
        if (ordersDB == null || !ordersDB
                .getStatus()
                .equals(Orders.DELIVERY_IN_PROGRESS)) {
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        ...
        //支付状态
        Integer payStatus = ordersDB.getPayStatus();
        if (payStatus == Orders.PAID.intValue()) {
            //用户已支付，需要退款
            // String refund = weChatPayUtil.refund(ordersDB.getNumber(), ordersDB.getNumber(), new BigDecimal(0.01), new BigDecimal(0.01));
            // log.info("申请退款：{}", refund);
            log.info("申请退款：{}", "");
    ...
    private String getOrderDishesStr(Orders orders) {
        ...
        List<String> orderDishList = orderDetailList
                .stream()
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        //         user.getOpenid());
        //
        // if (jsonObject.getString("code") != null && jsonObject
        //         .getString("code")
        //         .equals("ORDERPAID")) {
